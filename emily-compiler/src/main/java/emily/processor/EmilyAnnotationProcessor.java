...
public class EmilyAnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for (Element annotatedElement : roundEnv.getElementsAnnotatedWith(LocalStorage.class)) {
            ...
            TypeSpec.Builder generatedClassBuilder = TypeSpec.classBuilder("Emily" + annotatedElement.getSimpleName())
            ...
            generatedClassBuilder.addField(contextVariable).addField(sharedPrefVariable).addField(serializer).addMethod(constructor).addMethod(getSharedPrefs).addMethod(getContext);
